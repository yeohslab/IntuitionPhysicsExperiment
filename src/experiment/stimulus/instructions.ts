...
<p><strong>汇报阶段</strong>: 你会看到橙色的边框与表示单摆可以到达的运动范围的橙色的虚线，你应该在画面上点击你认为单摆在遮挡阶段结束瞬间的位置</p>
<p><strong>反馈阶段</strong>（仅练习 Trial）: 你会看到橙色和蓝色的摆杆，橙色的摆杆表示您的选择，蓝色的摆杆表示在遮挡阶段结束瞬间，单摆的真实位置</p>
